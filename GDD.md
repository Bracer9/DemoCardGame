...
- **遗物**：当前已接入 25 件遗物，由 16 件跨体系 Common / Rare 组件与 9 件唯一 Epic 构筑终点组成；完整随机池仅按英雄路线 tag 做宽松加权，不设置路线硬门槛。详细口径见 `reference/TinyPixelFights_Relic_Design_20260708.md`。天气仍属于后续全局 modifier 系统。
