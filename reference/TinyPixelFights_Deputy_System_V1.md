...
| 决斗士 / Crimson Duelist | `deputy-duelist` | 物攻 +2 | 每己方 turn 1 次，宿主主动攻击带有通用 Debuff 的敌人时，伤害计算前获得 1 turn 强攻。若目标已有 2 个及以上通用 Debuff，强攻持续改为 2 turn。 | 强攻 |
| 秘术士 / Astral Arcanist | `deputy-arcanist` | 魔攻 +2 | 每己方 turn 1 次，宿主造成魔法伤害，或宿主成功赋予燃烧 / 空虚 / 力竭 / 磨损后，宿主获得咏唱，并可以再次主动攻击。若由宿主的 Role Action 触发，咏唱层数仍为 2 层。 | 咏唱 |
...
| 秘术士 | 魔法师带秘术士副官，使用灼热刻印赋予燃烧 / 空虚 | 魔法师获得咏唱，并可以再次主动攻击。 |
